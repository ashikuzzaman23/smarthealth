...
public class BloodPressureActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateDisplay = (EditText) findViewById(R.id.editText_blood);
        calenderIcon = (ImageButton) findViewById(R.id.imageButton_blood);
        listView = (ListView) findViewById(R.id.list_view_blood);
    ...
    {
        String url;
        QueryManager queryManager = new QueryManager(HomeActivity.channelID,date,2,HomeActivity.API_KEY);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            arrayList.add(new Data("Timestamp","SBP/DBP(mmHg)"));
                            ArrayList<String> timestamp=null;
                            ArrayList<String> value=null;
                            JsonParser jsonParser = new JsonParser(response);
                            jsonParser.parseFieldData(2);
                            ...
                            {
                                Toast.makeText(BloodPressureActivity.this,"No data on storage",Toast.LENGTH_SHORT).show();
                            }
                            DataArrayAdapter adapter = new DataArrayAdapter(BloodPressureActivity.this,R.layout.adapter_view_layout,arrayList);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(BloodPressureActivity.this,"Error in Connection",Toast.LENGTH_SHORT).show();
            }
        });
